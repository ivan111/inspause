...
# Latest Revision: 16 Nov 2009, 11.00 GMT
#
...
class PersistentObject(object):
    ...
    def __init__(self, window, persistenceHandler=None):
        ...
        :param `window`: an instance of L{wx.Window};
...
class PersistenceManager(object):
    ...
    def __init__(self):
        ...
        - `configFile`: the persistent configuration file for L{PersistenceManager},
          a custom file name to which L{wx.FileConfig} will access to store and
    ...
    def GetPersistenceDirectory(self):
        ...
        :note: The return value of this method is not used if you are using your own
         custom configuration handler (i.e., by using ConfigObj/ConfigParser/cPickle etc...)
         or if you have specified a custom configuration file to use with L{wx.FileConfig}.
        """
    ...
    def Unregister(self, window):
        ...
        :param `window`: an instance of L{wx.Window}, which must have been previously
    ...
    def SaveAndUnregister(self, window=None):
        ...
        :param `window`: an instance of L{wx.Window}. If it is ``None``, all the
    ...
    def SaveValue(self, obj, keyName, value):
        ...
        By default this method simply use L{wx.FileConfig} but this behaviour may be
