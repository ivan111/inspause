...
* wx.ToggleButton, wx.lib.buttons.GenToggleButton, wx.lib.buttons.GenBitmapToggleButton,
  wx.lib.buttons.GenBitmapTextToggleButton, wx.lib.agw.shapedbutton.SToggleButton,
  wx.lib.agw.shapedbutton.SBitmapToggleButton, wx.lib.agw.shapedbutton.SBitmapTextToggleButton;
...
* Find a way to handle `wx.ToolBar` UI settings as it has been done for `wx.lib.agw.aui.AuiToolBar`:
...
Latest revision: Andrea Gavana @ 16 Nov 2009, 11.00 GMT
Version 0.1. 
