...
##Saving it for when UltimateListCtrl ends up in wx.lib.agw
##import wx.lig.agw.ultimatelistctrl as ULC
...
def PyDate2wxDate(date):
    """
    Transforms a datetime.date object into a L{wx.DateTime} one.
...
def wxDate2PyDate(date):
    """
    Transforms a L{wx.DateTime} object into a datetime.date one.

    :param date: a L{wx.DateTime} object.
    """
...
def CreateFont(font):
    """
    Returns a tuple of 7 L{wx.Font} attributes from the `font` input parameter.

    :param `font`: a L{wx.Font} instance.
    """
...
class AbstractHandler(object):
    ...
    :note: This is an abstract class. If you wish to add another (custom) handler
           for your widgets, you should derive from AbstractHandler and override
           the Save(), Restore() and GetKind() methods.
    """
    ...
    def __init__(self, pObject):
        ...
        :param `pObject`: a PersistentObject containing information about the
        persistent widget.
        """
    ...
    def Save(self):
        """
        Saves the widget's settings by calling PM.PersistentObject.SaveValue(), which in
        turns calls PM.PersistenceManager.SaveValue().
    ...
    def Restore(self):
        """
        Restores the widget's settings by calling PM.PersistentObject.RestoreValue(), which in
        turns calls PM.PersistenceManager.RestoreValue().
...
class BookHandler(AbstractHandler):
    ...
    - L{wx.Choicebook};
    - L{wx.Listbook};
    - L{wx.Treebook} (except for opened tree branches, see L{TreebookHandler} for this);
    - L{wx.Notebook};
    - L{wx.aui.AuiNotebook};
    - L{wx.lib.agw.aui.AuiNotebook};
    - L{wx.lib.agw.flatnotebook.FlatNotebook};
    - L{wx.lib.agw.labelbook.LabelBook};
    - L{wx.lib.agw.labelbook.FlatImageBook}.
...
class TreebookHandler(BookHandler):
    ...
    - L{wx.Treebook} (except for page selection, see L{BookHandler} for this).
...
class AUIHandler(AbstractHandler):
    """
    Supports saving/restoring wx.aui.AuiManager and wx.lib.agw.aui.AuiManager
    perspectives.
    """
...
class TLWHandler(AUIHandler):
    ...
    - All L{wx.Frame} derived classes;
    - All L{wx.Dialog} derived classes.

    In addition, if the toplevel window has an associated AuiManager (whether it is 
    L{wx.aui.AuiManager} or L{wx.lib.agw.aui.AuiManager} and L{PM.PersistenceManager}
...
class ListBoxHandler(AbstractHandler):
    ...
    - L{wx.ListBox};
    - L{wx.ListCtrl} (only for selected items. For column sizes see L{ListCtrlHandler});
    - L{wx.ListView} (only for selected items. For column sizes see L{ListCtrlHandler});
    - L{wx.VListBox};
    - L{wx.HtmlListBox};
    - L{wx.SimpleHtmlListBox};
    - L{wx.gizmos.EditableListBox}.    
    ...
    def GetSelections(self, listBox):
        """
        Returns a list of selected items for wx.ListCtrl, wx.ListView, wx.VListBox,
        wx.HtmlListBox, wx.SimpleHtmlListBox, wx.gizmos.EditableListBox.

        :param `listBox`: an instance of wx.ListCtrl, wx.ListView, wx.VListBox,
         wx.HtmlListBox, wx.SimpleHtmlListBox, wx.gizmos.EditableListBox.
        """
...
class ListCtrlHandler(ListBoxHandler):
    ...
    - L{wx.ListCtrl} (only for column sizes. For selected items see L{ListBoxHandler});
    - L{wx.ListView} (only for column sizes. For selected items see L{ListBoxHandler}).
    """
...
class CheckListBoxHandler(ListBoxHandler):
    ...
    - L{wx.CheckListBox} (only for checked items. For selected items see L{ListBoxHandler}).
...
class ScrolledWindowHandler(AbstractHandler):
    ...
    - L{wx.ScrolledWindow};
    - L{wx.lib.scrolledpanel.ScrolledPanel}.
...
class TextCtrlHandler(AbstractHandler):
    ...
    - L{wx.TextCtrl};
    - L{wx.SearchCtrl};
    - L{wx.lib.expando.ExpandoTextCtrl};
    - L{wx.lib.masked.TextCtrl};
    - L{wx.lib.masked.ComboBox};
    - L{wx.lib.masked.IpAddrCtrl};
    - L{wx.lib.masked.TimeCtrl};
    - L{wx.lib.masked.NumCtrl};
...
class ToggleButtonHandler(AbstractHandler):
    ...
    - L{wx.ToggleButton};
    - L{wx.lib.buttons.GenToggleButton};
    - L{wx.lib.buttons.GenBitmapToggleButton};
    - L{wx.lib.buttons.GenBitmapTextToggleButton};
    - L{wx.lib.agw.shapedbutton.SToggleButton};
    - L{wx.lib.agw.shapedbutton.SBitmapToggleButton};
    - L{wx.lib.agw.shapedbutton.SBitmapTextToggleButton}.
...
class TreeCtrlHandler(AbstractHandler):
    ...
    checked items state (meaningful only for CustomTreeCtrl).

    This class handles the following wxPython widgets:

    - L{wx.TreeCtrl};
    - L{wx.GenericDirCtrl};
    - L{wx.lib.agw.customtreectrl.CustomTreeCtrl}.
    ...
    def GetItemChildren(self, item=None, recursively=False):
        ...
        :param `item`: a L{wx.TreeCtrl} item or a L{wx.lib.agw.customtreectrl.CustomTreeCtrl} item;
    ...
    def SetExpansionState(self, listOfExpandedItems):
        ...
        :param `listOfExpandedItems`: a list of expanded L{wx.TreeCtrl} or
         L{wx.lib.agw.customtreectrl.CustomTreeCtrl} items.
        """
    ...
    def SetSelectionState(self, listOfSelectedItems):
        ...
        :param `listOfSelectedItems`: a list of selected L{wx.TreeCtrl} or
         L{wx.lib.agw.customtreectrl.CustomTreeCtrl} items.
        """
    ...
    def GetCheckedState(self):
        ...
        :note: This is meaningful only for L{wx.lib.agw.customtreectrl.CustomTreeCtrl} and
         L{wx.lib.agw.hypertreelist.HyperTreeList}.
        """
    ...
    def SetCheckedState(self, listOfCheckedItems):
        ...
        :param `listOfCheckedItems`: a list of checked L{wx.lib.agw.customtreectrl.CustomTreeCtrl} items.
    ...
    def GetCheckedStateOfItem(self, item):
        ...
        :param `item`: a L{wx.lib.agw.customtreectrl.CustomTreeCtrl} item.
        """
...
class TreeListCtrlHandler(TreeCtrlHandler):
    """
    Supports saving/restoring a wx.gizmos.TreeListCtrl/wx.lib.agw.hypertreelist expansion state,
    selections, column widths and checked items state (meaningful only for HyperTreeList).

    This class handles the following wxPython widgets:

    - L{wx.gizmos.TreeListCtrl};
    - L{wx.lib.agw.hypertreelist.HyperTreeList}.
...
class CalendarCtrlHandler(AbstractHandler):
    ...
    - L{wx.lib.calendar.CalendarCtrl}.
...
class ColourPickerHandler(AbstractHandler):
    ...
    - L{wx.ColourPickerCtrl};
    - L{wx.lib.colourselect.ColourSelect}.
...
class MenuBarHandler(AbstractHandler):
    """
    Supports saving/restoring the wx.MenuBar items state.

    This class handles the following wxPython widgets:

    - L{wx.MenuBar};
    - L{wx.lib.agw.flatmenu.FlatMenuBar}.
...
class ColourDialogHandler(TLWHandler):
    ...
    - L{wx.ColourDialog};
    - L{wx.lib.agw.cubecolourdialog.CubeColourDialog}.
...
class ChoiceDialogHandler(TLWHandler):
    ...
    - L{wx.SingleChoiceDialog};
    - L{wx.MultiChoiceDialog}.
...
class TextEntryHandler(TLWHandler, TextCtrlHandler):
    ...
    - L{wx.TextEntryDialog};
    - L{wx.PasswordEntryDialog}.
...
def FindHandler(pObject):
    ...
    :param `pObject`: an instance of L{PM.PersistentObject} class.
    """
